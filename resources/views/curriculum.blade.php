    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pt-10 pb-20">
        <div class="md:flex">
            <div class="w-full md:w-3/4 px-4 text-justify">
                ...
                <p class="mb-4">Pesantren Modern Khalifah menerapkan kurikulum terpadu yang mengombinasikan pendidikan formal (SMP & SMA) dengan pendidikan diniyah. Santri tidak hanya mendapatkan ilmu akademik, tetapi juga pemahaman agama yang mendalam serta keterampilan hidup untuk menghadapi tantangan masa depan.</p>
                <x-text-header>Kurikulum yang Kami Terapkan</x-text-header>
                <p class="mb-4 font-bold">Kurikulum Diniyah (Keislaman) – Membentuk Akhlak Mulia</p>
                <ul class="mb-4">
                ...
                <p class="mb-4 font-bold">Kurikulum Nasional (Akademik) – Mempersiapkan Masa Depan Santri</p>
                <ul class="mb-4">
                ...
                <p class="mb-4">💡 Dengan kurikulum ini, santri tidak hanya unggul secara akademik tetapi juga siap menjadi pemimpin yang berakhlak dan berdaya saing global!</p>
            </div>
            ...
            <div class="w-full md:w-1/4 px-4">
                ...
                <div x-data="{ open: 1 }" class="space-y-4">
                    <div class="border border-gray-800 rounded-md shadow-md">
        ...
        {{-- Calender Pendidikan --}}
        <div class="mt-10 w-full md:w-3/4 px-4">
