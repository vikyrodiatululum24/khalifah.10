<nav x-data="{ open: false, scrolled: false }" 
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 items-center sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="center" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('student')" :active="request()->routeIs('student')">
                                {{ __('Student') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('psb')" :active="request()->routeIs('psb')">
                                {{ __('PSB') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden md:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('psb')" :active="request()->routeIs('psb')">
                {{ __('PSB') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
