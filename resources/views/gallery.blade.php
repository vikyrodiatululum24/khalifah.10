<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-10 flex flex-wrap justify-center gap-4">
      <div class="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-md intersect:motion-scale-in-0 intersect:motion-opacity-in-0 origin-top">
        <div class="h-96 w-72">
          <img class="h-full w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="https://cdn.flyonui.com/fy-assets/components/card/image-5.png" alt="" />
        </div>
